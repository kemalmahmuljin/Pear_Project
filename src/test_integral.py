...
# Setting phi
phiis = [phi_1, phi_2, phi_3] ## iterating over rows
for phii in phiis:
	#### IMPLEMENTING Ru
	...
	Dvv1 = - r*Kmfu*Vmfv*phi_1*phii/( (Kmfu+C_a_u)**2 )
	Dvv2 = - r*Kmfu*Vmfv*phi_2*phii/( (Kmfu+C_a_u)**2 )	
	Dvv3 = - r*Kmfu*Vmfv*phi_3*phii/( (Kmfu+C_a_u)**2 )
	Dc1_v = rq*Dc1_u + Dvv1	
	Dc2_v = rq*Dc2_u + Dvv2
	Dc3_v = rq*Dc3_u + Dvv3
	DcM1_v = rq*DcM1_u
	...
	integrand_f = F -(C_a_u*Dvv1+C_a_u*Dvv2+C_a_u*Dvv3)
