...
J = jacobian_integrand(elements, coords, x, 0, 0.5, coefficients, VAR) + ...
    jacobian_integrand(elements, coords, x, 0.5, 0, coefficients, VAR) + ...
    jacobian_integrand(elements, coords, x, 0.5, 0.5, coefficients, VAR);
J = J/6.0 + stiffness;
end
